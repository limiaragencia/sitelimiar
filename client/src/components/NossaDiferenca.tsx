    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-200 max-w-4xl mx-auto leading-relaxed font-poppins font-thin ml-[167px] mr-[167px] pl-[0px] pr-[0px] pt-[0px] pb-[0px] mt-[-10px] mb-[-10px] text-justify" style={{ textShadow: '3px 3px 8px rgba(0,0,0,0.9), 1px 1px 4px rgba(0,0,0,0.8)' }}>
