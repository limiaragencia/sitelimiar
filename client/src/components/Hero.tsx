      ...
      <div className="relative z-20 container mx-auto px-6 font-thin">
        <div className="max-w-4xl">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-poppins font-bold mb-6 leading-tight animate-fade-in-up text-left">
            ...
            <span className="block md:text-2xl lg:text-3xl text-white drop-shadow-2xl pl-[-31px] pr-[-31px] ml-[0px] mr-[0px] font-thin pt-[70px] pb-[70px] mt-[51px] mb-[51px] text-[55px]">
          ...
          <div className="w-full max-w-5xl animate-fade-in-up">
            ...
            {/* Scroll Indicator */}
            <div className="flex justify-center animate-fade-in-up mt-[18px] mb-[18px] pt-[6px] pb-[6px] pl-[-15px] pr-[-15px] ml-[-359px] mr-[-359px]">
