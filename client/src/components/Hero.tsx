        ...
        <div className="max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row gap-8 items-start animate-fade-in-up">
            <div className="flex items-center gap-3 group animate-[slideInLeft_0.8s_ease-out_0.2s_both]">
              ...
              <span className="font-medium text-white drop-shadow-lg group-hover:bg-gradient-to-r group-hover:from-limiar-orange group-hover:to-limiar-gold group-hover:bg-clip-text group-hover:text-transparent transition-all duration-300 mt-[0px] mb-[0px] pt-[20px] pb-[20px] text-[22px]">50+ marcas transformadas</span>
            </div>
            <div className="flex items-center gap-3 group animate-[slideInLeft_0.8s_ease-out_0.4s_both]">
              ...
              <span className="font-medium text-white drop-shadow-lg group-hover:bg-gradient-to-r group-hover:from-limiar-orange group-hover:to-limiar-gold group-hover:bg-clip-text group-hover:text-transparent transition-all duration-300 pt-[20px] pb-[20px] text-[25px]">Ecossistema de IA</span>
            </div>
