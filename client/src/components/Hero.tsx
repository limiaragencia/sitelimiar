          ...
          <svg className="absolute inset-0 w-full h-full" viewBox="0 0 1200 800" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <linearGradient id="wave1" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="var(--limiar-orange)" stopOpacity="0.1"/>
                <stop offset="100%" stopColor="var(--limiar-gold)" stopOpacity="0.2"/>
              </linearGradient>
              <linearGradient id="wave2" x1="0%" y1="0%" x2="100%" y2="0%">
                <stop offset="0%" stopColor="var(--limiar-gold)" stopOpacity="0.15"/>
                <stop offset="100%" stopColor="var(--limiar-orange)" stopOpacity="0.1"/>
              </linearGradient>
            </defs>
            ...
            <path 
              ...
              fill="url(#wave1)"
              className="animate-[waveMove1_8s_ease-in-out_infinite]"
            />
            <path 
              d="M0,450 Q400,350 800,450 T1200,450 L1200,800 L0,800 Z" 
              fill="url(#wave2)"
              className="animate-[waveMove2_10s_ease-in-out_infinite_2s]"
            />
          </svg>
        </div>
        
        {/* Floating Particles */}
        <div className="absolute top-1/4 left-1/4 w-32 h-32 bg-gradient-to-r from-limiar-orange/20 to-limiar-gold/20 rounded-full blur-xl animate-[floatSlow_6s_ease-in-out_infinite]"></div>
        <div className="absolute top-3/4 right-1/4 w-24 h-24 bg-gradient-to-r from-limiar-gold/15 to-limiar-orange/15 rounded-full blur-lg animate-[floatSlow_8s_ease-in-out_infinite_1s]"></div>
        <div className="absolute top-1/2 left-1/3 w-16 h-16 bg-gradient-to-r from-limiar-orange/25 to-limiar-gold/25 rounded-full blur-md animate-[floatSlow_7s_ease-in-out_infinite_0.5s]"></div>
        <div className="absolute bottom-1/4 right-1/3 w-20 h-20 bg-gradient-to-r from-limiar-gold/20 to-limiar-orange/20 rounded-full blur-lg animate-[floatSlow_9s_ease-in-out_infinite_2s]"></div>
        <div className="absolute top-1/6 right-1/6 w-12 h-12 bg-gradient-to-r from-limiar-orange/30 to-limiar-gold/30 rounded-full blur-sm animate-[floatSlow_5s_ease-in-out_infinite_1.5s]"></div>
        <div className="absolute bottom-1/3 left-1/6 w-28 h-28 bg-gradient-to-r from-limiar-gold/10 to-limiar-orange/10 rounded-full blur-xl animate-[floatSlow_10s_ease-in-out_infinite_3s]"></div>
      </div>
      ...
      <div className="relative z-10 container mx-auto px-6 font-thin">
        <div className="max-w-4xl">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-poppins font-bold mb-6 leading-tight animate-fade-in-up text-left">
            ...
            <span className="block md:text-2xl lg:text-3xl text-gray-700 dark:text-gray-300 pt-[55px] pb-[55px] pl-[-31px] pr-[-31px] ml-[0px] mr-[0px] font-thin mt-[28px] mb-[28px] text-[55px]">
