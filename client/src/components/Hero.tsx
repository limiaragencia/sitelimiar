      ...
      <div className="relative z-10 container mx-auto px-6">
        <div className="max-w-4xl">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-poppins font-bold mb-6 leading-tight animate-fade-in-up text-left">
            ...
            <span className="block md:text-5xl lg:text-6xl text-limiar-orange pl-[0px] pr-[0px] ml-[0px] mr-[0px] font-light text-[45px] pt-[6px] pb-[6px] mt-[-22px] mb-[-22px]">
              o que foi e o que
            </span>
            <span className="block md:text-5xl lg:text-6xl text-limiar-orange pt-[10px] pb-[10px] pl-[0px] pr-[0px] mt-[1px] mb-[1px] ml-[0px] mr-[0px] font-light text-[45px]">
              está por vir.
            </span>
