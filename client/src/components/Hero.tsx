      ...
      <div className="relative z-20 container mx-auto px-6 font-thin">
        <div className="max-w-4xl">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-poppins font-bold mb-6 leading-tight animate-fade-in-up text-left">
            ...
            <span className="block md:text-5xl lg:text-6xl text-limiar-orange pl-[0px] pr-[0px] ml-[0px] mr-[0px] text-[45px] pt-[6px] pb-[6px] font-black mt-[-38px] mb-[-38px]">
              o que foi e o que <span className="font-extrabold tracking-tight text-[65px]">está por vir</span>.
            </span>
            <span className="block md:text-2xl lg:text-3xl text-white drop-shadow-2xl pl-[-31px] pr-[-31px] ml-[0px] mr-[0px] font-thin mt-[35px] mb-[35px] text-[55px] pt-[70px] pb-[70px]">
          ...
          <div className="w-full max-w-5xl animate-fade-in-up">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 justify-items-center">
              <div className="flex items-center gap-4 group animate-[slideInLeft_0.8s_ease-out_0.2s_both] justify-center md:justify-start">
                ...
                <span className="font-medium text-white drop-shadow-lg group-hover:bg-gradient-to-r group-hover:from-limiar-orange group-hover:to-limiar-gold group-hover:bg-clip-text group-hover:text-transparent transition-all duration-300 text-base text-center md:text-left">50+ marcas transformadas</span>
              </div>
