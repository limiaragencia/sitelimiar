        ...
        <div className="max-w-4xl">
          ...
          <div className="w-full max-w-5xl animate-fade-in-up mb-16">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 justify-items-center">
              ...
              <div className="flex items-center gap-4 group animate-[slideInLeft_0.8s_ease-out_0.4s_both] justify-center p-4 rounded-lg transition-all duration-300 hover:shadow-[0_10px_30px_rgba(255,127,0,0.2)] hover:bg-white/5 backdrop-blur-sm pl-[36px] pr-[36px] ml-[11px] mr-[11px] mt-[12px] mb-[12px] pt-[13px] pb-[13px]">
                <div className="relative">
